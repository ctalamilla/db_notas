...
insert into `usuarios`  values (1, 'Dynah', 'dtimpany0@engadget.com');
insert into `usuarios` values (2, 'Berky', 'bmassimi1@tamu.edu');
insert into `usuarios` values (3, 'Samantha', 'stitman2@nasa.gov');
insert into `usuarios`  values (4, 'Gerti', 'growth3@dion.ne.jp');
insert into `usuarios`  values (5, 'Bellina', 'bpollastrino4@umn.edu');
insert into `usuarios`  values (6, 'Vera', 'vcorwood5@yahoo.co.jp');
insert into `usuarios` values (7, 'Wendeline', 'wbaudouin6@shareasale.com');
insert into `usuarios` values (8, 'Todd', 'ttall7@unc.edu');
insert into `usuarios` values (9, 'Lorine', 'lgrimsdale8@nih.gov');
insert into `usuarios`  values (10, 'Malvina', 'mmagister9@diigo.com');
insert into `usuarios` values (11, 'Eb', 'epleagera@upenn.edu');
insert into `usuarios`  values (12, 'Rivi', 'rperigeauxb@si.edu');
...
insert into categorias (idCat, name) values (1, 'Kids');
insert into categorias (idCat, name) values (2, 'Jewelry');
insert into categorias (idCat, name) values (3, 'Garden');
insert into categorias (idCat, name) values (4, 'Clothing');
insert into categorias (idCat, name) values (5, 'Automotive');
insert into categorias (idCat, name) values (6, 'Kids');
insert into categorias (idCat, name) values (7, 'Electronics');
insert into categorias (idCat, name) values (8, 'Music');
insert into categorias (idCat, name) values (9, 'Shoes');
insert into categorias (idCat, name) values (10, 'Automotive');
